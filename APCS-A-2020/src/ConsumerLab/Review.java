...
public class Review {
	...
	/**
	 * Method to return a string containing all of the text in fileName (including
	...
	/**
	 * Method that returns the sentiment value of word as a number between -4 (very
	 * negative) to 3 (very positive sentiment)
	 * 
	 ...
	 * 
	 * @return a random adjective found in either randomNegativeAdjectives.txt or
	 *         randomPositiveAdjectives.txt
	 */
	...
	/**
	 * Method to determine the star rating of a review found in the text file
	 * provided by the parameter.
	 * 
	 * @param fileName - the name of the file containing the review
	 * @return the star rating of the review, which is an integer value between 0
	 *         and 4
	 */
	...
	/**
	 * Method to create and return a strong fake review using String methods to
		...
		while (reviewWords.length() > 0) {
			...
			if (oneWord.substring(0, 1).equals("*")) {
				...
				if (sentimentValue > 0) {
					...
					double replacementSentimentValue = sentimentVal(replacementWord);
					// loop until stronger adjective found
					while (replacementSentimentValue < sentimentValue) {
						replacementWord = randomAdjective();
						replacementSentimentValue = sentimentVal(replacementWord);
					}
